...
const COURSE_OBSTACLES = [
  { type: "crt", x: 900, width: 38, height: 32, spriteKey: "crt", hitbox: { offsetX: 4, offsetY: 5, width: 30, height: 25 } },
  ...
  { type: "crt", x: 3420, width: 38, height: 32, spriteKey: "crt", hitbox: { offsetX: 4, offsetY: 5, width: 30, height: 25 } },
  ...
  { type: "crt", x: 5210, width: 38, height: 32, spriteKey: "crt", hitbox: { offsetX: 4, offsetY: 5, width: 30, height: 25 } },
  ...
  { type: "crt", x: 7010, width: 38, height: 32, spriteKey: "crt", hitbox: { offsetX: 4, offsetY: 5, width: 30, height: 25 } },
  ...
  { type: "crt", x: 9360, width: 38, height: 32, spriteKey: "crt", hitbox: { offsetX: 4, offsetY: 5, width: 30, height: 25 } },
...
const SECRET_COURSE_OBSTACLES = [
  { type: "crt", x: 760, width: 38, height: 32, spriteKey: "crt", hitbox: { offsetX: 4, offsetY: 5, width: 30, height: 25 } },
  ...
  { type: "crt", x: 3300, width: 38, height: 32, spriteKey: "crt", hitbox: { offsetX: 4, offsetY: 5, width: 30, height: 25 } },
  ...
  { type: "crt", x: 5780, width: 38, height: 32, spriteKey: "crt", hitbox: { offsetX: 4, offsetY: 5, width: 30, height: 25 } },
  ...
  { type: "crt", x: 7640, width: 38, height: 32, spriteKey: "crt", hitbox: { offsetX: 4, offsetY: 5, width: 30, height: 25 } },
  ...
  { type: "crt", x: 10140, width: 38, height: 32, spriteKey: "crt", hitbox: { offsetX: 4, offsetY: 5, width: 30, height: 25 } },
...
const SECRET_COURSE_ITEMS = [
  ...
  { type: "heart", x: 2360, y: 260, spriteKey: "heart", effect: "life" },
  ...
  { type: "heart", x: 6900, y: 248, spriteKey: "heart", effect: "life" },
